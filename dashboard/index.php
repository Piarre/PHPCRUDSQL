...
<div class="max-w-6xl mx-auto">
    <div class="flex justify-center gap-10 pb-4">
        <a class="flex items-center gap-[5px]  bg-violet-500 transition hover:bg-violet-800 my-2 hover:-translate-y-1 font-bold hover:scale-110 text-xl text-white p-3 rounded-md"
        ...
        <a class="flex items-center gap-[5px] bg-pink-500 transition hover:bg-pink-800 my-2 hover:-translate-y-1 font-bold hover:scale-110 text-xl text-white p-3 rounded-md"
           href="/dashboard/add.php">
